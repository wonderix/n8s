...
proc get*(client: Client, t: typedesc[Role], name: string, namespace = "default"): Future[Role] {.async.}=
  return await client.get("/apis/rbac.authorization.k8s.io/v1beta1", t, name, namespace)

proc create*(client: Client, t: Role, namespace = "default"): Future[Role] {.async.}=
  return await client.create("/apis/rbac.authorization.k8s.io/v1beta1", t, namespace)
...
proc replace*(client: Client, t: Role, namespace = "default"): Future[Role] {.async.}=
  return await client.replace("/apis/rbac.authorization.k8s.io/v1beta1", t, t.metadata.name, namespace)

proc watch*(client: Client, t: typedesc[Role], name: string, namespace = "default"): Future[FutureStream[WatchEv[Role]]] {.async.}=
  return await client.watch("/apis/rbac.authorization.k8s.io/v1beta1", t, name, namespace)
...
proc list*(client: Client, t: typedesc[Role], namespace = "default"): Future[seq[Role]] {.async.}=
  return (await client.list("/apis/rbac.authorization.k8s.io/v1beta1", RoleList, namespace)).items
...
proc list*(client: Client, t: typedesc[ClusterRole], namespace = "default"): Future[seq[ClusterRole]] {.async.}=
  return (await client.list("/apis/rbac.authorization.k8s.io/v1beta1", ClusterRoleList, namespace)).items
...
proc list*(client: Client, t: typedesc[ClusterRoleBinding], namespace = "default"): Future[seq[ClusterRoleBinding]] {.async.}=
  return (await client.list("/apis/rbac.authorization.k8s.io/v1beta1", ClusterRoleBindingList, namespace)).items
...
proc list*(client: Client, t: typedesc[RoleBinding], namespace = "default"): Future[seq[RoleBinding]] {.async.}=
  return (await client.list("/apis/rbac.authorization.k8s.io/v1beta1", RoleBindingList, namespace)).items
